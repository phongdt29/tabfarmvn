...
class PenciBigGrid extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'bgcontent_equalheight', array(
			'label'        => __( 'Enable Equal Height for Big Grid Content Area?', 'soledad' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'soledad' ),
			'label_off'    => __( 'No', 'soledad' ),
			'return_value' => 'yes',
			'default'      => '',
			'condition'    => array( 'bgcontent_pos' => array( 'below', 'above' ) ),
		) );
	...
	protected function render() {
		...
		if ( 'yes' == $settings['bgcontent_equalheight'] ) {
			$wrapper_class .= ' pcbg-equalh';
		}
