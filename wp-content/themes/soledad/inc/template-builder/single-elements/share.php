...
class PenciSingleShare extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		?>
        <div data-id="<?php echo esc_attr( $post_id ); ?>" class="<?php echo esc_attr( implode( ' ', $wrapper_class ) ); ?> post-share<?php if ( $settings['penci__hide_share_plike'] ): echo ' hide-like-count'; endif; ?>">
			<?php
			if ( 's1' != $style_cscount ) {
