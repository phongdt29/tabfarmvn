(function ($, api) {
    ...
    var $element_spacings = {
        ...
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_spacing)': '.penci-header-builder .pc-builder-element.pc-vertical-menu',
    ...
    var $color_css = {
        ...
        // vertical menu
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_color)': '.pc-builder-element.pc-vertical-menu .navigation .menu > li > a,.pc-builder-element.pc-vertical-menu .navigation ul.menu ul.sub-menu a',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_hv_color)': '.pc-builder-element.pc-vertical-menu .navigation .menu > li > a:hover,.pc-builder-element.pc-vertical-menu .navigation .menu > li:hover > a,.pc-builder-element.pc-vertical-menu .navigation ul.menu ul.sub-menu a:hover',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_active_color)': '.pc-builder-element.pc-vertical-menu .navigation .menu li.current-menu-item > a,.pc-builder-element.pc-vertical-menu .navigation .menu > li.current_page_item > a,.pc-builder-element.pc-vertical-menu .navigation .menu > li.current-menu-ancestor > a,.pc-builder-element.pc-vertical-menu .navigation .menu > li.current-menu-item > a',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_submenu_color)': '.pc-builder-element.pc-vertical-menu .navigation ul.menu ul.sub-menu li a',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_submenu_hv_color)': '.pc-builder-element.pc-vertical-menu .navigation ul.menu ul.sub-menu li a:hover',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_submenu_activecl)': '.pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu li.current-menu-item > a,.pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu > li.current_page_item > a,.pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu > li.current-menu-ancestor > a,.pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu > li.current-menu-item > a',
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_bg_color)': {
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu > li > a'
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_line_hv_color)': {
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation ul.menu > li > a:before, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu > ul > li > a:before'
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_menu_bg_hv_color)': {
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu > li > a:hover,.pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li > a:hover, .pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li:hover > a, .pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li.current-menu-item > a, .pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li.current_page_item > a, .pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li.current-menu-ancestor > a, .pc-builder-element.pc-vertical-menu .navigation.menu-item-padding .menu > li.current-menu-item > a'
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_bg_color)': {
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .penci-megamenu:not(.penci-block-mega), .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation.menu-style-1 .penci-megamenu:not(.penci-block-mega) .penci-mega-child-categories a.cat-active, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation.menu-style-1 .penci-megamenu .penci-mega-child-categories a.cat-active:before',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_child_cat_bg_color)': {
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .penci-megamenu:not(.penci-block-mega) .penci-mega-child-categories, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation.menu-style-2 .penci-megamenu .penci-mega-child-categories a.cat-active'
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_post_date_color)': {
            'color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .penci-megamenu:not(.penci-block-mega) .penci-mega-date',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_post_category_color)': {
            'color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .penci-megamenu .penci-mega-thumbnail .mega-cat-name',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_post_title_color)': {
            'color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu .penci-megamenu .penci-mega-latest-posts .penci-mega-post .post-mega-title a',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_accent_color)': {
            'color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .penci-megamenu:not(.penci-block-mega) .penci-mega-child-categories a.cat-active, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu .penci-megamenu .penci-mega-child-categories a:hover, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .menu .penci-megamenu .penci-mega-latest-posts .penci-mega-post .post-mega-title a:hover',
            'background-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation .penci-megamenu:not(.penci-block-mega) .penci-mega-thumbnail .mega-cat-name',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_mega_border_style2)': {
            'border-color': '.pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation.menu-style-2 .penci-megamenu .penci-mega-child-categories a::after',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_submenu_bordercolor)': {
            'border-color': '.pc-builder-element.pc-vertical-menu .penci-dropdown-menu,.pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu, .pc-builder-element.pc-vertical-menu .navigation ul.menu > li.megamenu > ul.sub-menu,.pc-builder-element.pc-vertical-menu .navigation ul.menu ul.sub-menu li > a, .pc-builder-element.pc-builder-menu.pc-vertical-menu .navigation.menu-style-1 .penci-megamenu:not(.penci-block-mega) .penci-mega-child-categories a.cat-active',
            'background-color': '.pc-builder-element.pc-vertical-menu .menu-style-2 .penci-megamenu .penci-content-megamenu .penci-mega-latest-posts .penci-mega-post:before,.pc-builder-element.pc-vertical-menu .navigation ul.menu > li.megamenu > ul.sub-menu > li:before, .pc-builder-element.pc-vertical-menu .navigation.menu-style-2 .penci-megamenu .penci-mega-child-categories a.all-style:before,.pc-builder-element.pc-vertical-menu .navigation .penci-megamenu .penci-mega-child-categories:after',
            'border-top-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-2 .menu .sub-menu',
            'border-bottom-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-3 .menu .sub-menu:before',
            'border-right-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-3 .menu .sub-menu .sub-menu:before',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_submenu_bgcolor)': {
            'border-bottom-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-3 .menu .sub-menu:after',
            'border-right-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-3 .menu .sub-menu .sub-menu:after',
            'background-color': '.pc-builder-element.pc-vertical-menu .navigation ul.menu > li.megamenu > ul.sub-menu, .pc-builder-element.pc-vertical-menu .navigation .menu .sub-menu, .pc-builder-element.pc-vertical-menu .navigation .menu .children'
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_drop_border_style2)': {
            'background-color': '.pc-builder-element.pc-vertical-menu .navigation.menu-style-2 ul.menu ul.sub-menu:before'
        },
        ...
        // vertical menu
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_font_for_menu)': {
            '--pchb-vertical-menu-font': '.pc-builder-element.pc-vertical-menu',
            'font-family': '.pc-builder-element.pc-vertical-menu',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_font_weight_menu)': {
            'font-weight': '.pc-builder-element.pc-vertical-menu .navigation .menu li a',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_font_size_lv1)': {
            '--pchb-vertical-menu-fs': '.pc-builder-element.pc-vertical-menu',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_font_size_drop)': {
            '--pchb-vertical-menu-fs_l2': '.pc-builder-element.pc-vertical-menu',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_lv1_item_spacing)': {
            '--pchb-vertical-menu-mg': '.pc-builder-element.pc-vertical-menu',
        },
        'setting(penci_header_pb_vertical_menu_section)(penci_header_pb_vertical_menu_penci_lv1_item_margin)': {
            '--pchb-vertical-menu-mgi': '.pc-builder-element.pc-vertical-menu',
        },
        ...
        'setting(penci_header_topblockbar_setting_section)(penci_header_topblock_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-desktop-topblock',
        },
        ...
        'setting(penci_header_topbar_setting_section)(penci_header_topbar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-desktop-topbar',
        },
        ...
        'setting(penci_header_midbar_setting_section)(penci_header_midbar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-desktop-midbar',
        },
        ...
        'setting(penci_header_bottombar_setting_section)(penci_header_bottombar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-desktop-bottombar',
        },
        ...
        'setting(penci_header_bottomblockbar_setting_section)(penci_header_bottomblock_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-desktop-bottomblock',
        },
        ...
        'setting(penci_header_desktop_sticky_top_section)(penci_header_sticky_top_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-sticky-top',
        },
        ...
        'setting(penci_header_desktop_sticky_mid_section)(penci_header_sticky_mid_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-sticky-mid',
        },
        ...
        'setting(penci_header_desktop_sticky_bottom_section)(penci_header_sticky_bottom_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-sticky-bottom',
        },
        ...
        'setting(penci_header_mobile_topbar_setting_section)(penci_header_mobile_topbar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-mobile-topbar',
        },
        ...
        'setting(penci_header_mobile_midbar_setting_section)(penci_header_mobile_midbar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-mobile-midbar',
        },
        ...
        'setting(penci_header_mobile_bottombar_setting_section)(penci_header_mobile_bottombar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-mobile-bottombar',
        },
        ...
        'setting(penci_header_drawer_container_section)(penci_header_mobile_sidebar_shadow_setting)': {
            '--pc-box-shadow-color': '.penci-builder-mobile-sidebar-nav.penci-menu-hbg',
        },
    ...
    function spacing_elements(value, selector, boxShadowColor = 'var(--pc-box-shadow-color, #f1f1f1)') {
        // Normalize values (remove spaces, split, cast)
        const mpb = value
            .replace(/\s+/g, '')
            .split(',')
            .map(v => (v !== '-' && v !== '' && !isNaN(v)) ? parseInt(v, 10) : null);

        // Property map (same order as PHP)
        const map = {
            0: 'margin-top',
            1: 'margin-right',
            2: 'margin-bottom',
        ...
        // Apply spacing / border / radius
        Object.keys(map).forEach(index => {
            const val = mpb[index];
            if (val !== null) {
                createCssRule(selector, `${map[index]}:${val}px;`);
            }
        });

        // ---- Box shadow (indexes 16–19) ----
        const shadow = mpb.slice(16, 20);

        // Match PHP logic: render only if at least one value exists
        if (shadow.some(v => v !== null && v !== 0)) {
            const x      = shadow[0] ?? 0;
            const y      = shadow[1] ?? 0;
            const blur   = shadow[2] ?? 0;
            const spread = shadow[3] ?? 0;

            // NOTE: boxShadowColor should be defined in your preview context
            createCssRule(
                selector,
