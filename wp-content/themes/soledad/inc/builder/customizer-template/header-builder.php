...
<div class="header-builder">
    ...
    <div class="desktop-mode header-tab">
		...
		<div class="penci-builder-element-mode">
			<span class="penci-builder-element-mode-btn"><?php echo esc_html_e( 'Toggle Elements', 'soledad'); ?></span>
		</div>
    </div>
...
<!-- Shared item selection popover -->
<div class="header-item-popover" id="header-item-popover">
	<?php
	// This will be populated dynamically by JavaScript based on current device/context
	?>
</div>