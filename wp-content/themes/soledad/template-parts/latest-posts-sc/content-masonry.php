...
<article id="post-<?php the_ID(); ?>" class="item item-masonry grid-masonry hentry<?php if( 'yes' == $grid_meta_overlay ): echo ' grid-overlay-meta'; endif; ?>">
	...
	<div class="grid-header-box">
		...
		<?php endif; ?>
		<<?php echo esc_attr( $heading_title_tag ); ?> class="penci-entry-title entry-title grid-title <?php echo $heading_title_tag_class;?>"><a href="<?php the_permalink(); ?>"><?php penci_trim_post_title( get_the_ID(), $grid_title_length ); ?></a></<?php echo esc_attr( $heading_title_tag ); ?>>
